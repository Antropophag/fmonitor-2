...
final class LegacyActiveBaselineReadModel
{
    ...
    private function joins():string{return"LEFT JOIN `{$this->prefix}fm2_checklist_template_associations` a ON a.subject_kind='legacy_active_baseline' AND CAST(a.subject_id AS UNSIGNED)=b.id LEFT JOIN `{$this->prefix}fm2_checklist_template_snapshots` t ON t.id=a.template_snapshot_id";}
