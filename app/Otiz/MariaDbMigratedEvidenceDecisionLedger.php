...
require_once __DIR__.'/MariaDbMigratedEvidenceReconciliation.php';
require_once __DIR__.'/MariaDbMigratedEvidenceProjectionStore.php';
...
final class MigratedEvidenceDecisionLedger
{
    ...
    private function authorized(int $actor):bool{$p=\FMonitor2\IdentityAccess\MariaDbPilotAccessPolicy::class;return $p::grants($p::forUser($this->db,$this->prefix,$actor),$p::OTIZ_MANAGE);}
