...
{
    private const ALLOWED=['access.administer'];
    ...
    {
        if($params!==[]||!in_array($permissionName,self::ALLOWED,true))throw new \yii\base\InvalidArgumentException('Unknown permission.');
