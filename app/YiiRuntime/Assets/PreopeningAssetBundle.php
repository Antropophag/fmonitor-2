...
final class PreopeningAssetBundle extends \yii\web\AssetBundle
{
    ...
    public $css=['shlz.css','pilot.css','preopening.css'];public $js=['preloader.js','navigation.js','preopening.js','template-offer.js'];public $jsOptions=['position'=>\yii\web\View::POS_END];
}
