...
?>
<div class="fm2-page-header"><div><h1>Обратная связь</h1><p>Расскажите о проблеме или пожелании</p></div></div>
<?php if (
    $error !== ""
...
?><label class="shlz-field shlz-field--textarea" for="feedback-description"><span class="shlz-field__label">Описание</span><span class="shlz-field__control"><textarea class="shlz-textarea fm2-feedback-textarea" id="feedback-description" name="description" rows="6" maxlength="4000" required><?= Html::encode(
    $description,
) ?></textarea></span></label><button class="shlz-button shlz-button--primary" type="submit">Отправить обращение</button> <a class="shlz-button shlz-button--secondary" href="<?= Html::encode(
    $pagePath,
