...
<?php if(is_array($technicalDocument)):?><div class="shlz-surface fm2-technical-document-surface"><a class="shlz-button shlz-button--secondary fm2-control-document-button fm2-technical-document-link" href="<?=Html::encode($technicalDocument['url'])?>" target="_blank" rel="noopener noreferrer">Техническая документация</a></div><?php endif?>
