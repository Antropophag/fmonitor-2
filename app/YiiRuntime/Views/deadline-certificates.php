...
<label class="shlz-field fm2-file-field"><span class="shlz-field__label">PDF</span><span class="shlz-field__control fm2-file-control"><input class="fm2-file-input" type="file" name="pdf" accept="application/pdf" required><span class="shlz-button shlz-button--secondary" aria-hidden="true">Выбрать PDF</span><span class="fm2-file-name" data-file-name>Файл не выбран</span></span><span class="shlz-field__secondary">Один PDF-файл со справкой.</span></label>
