...
<div class="fm2-object-dashboard">
    ...
    <main>
        ...
        <section class="fm2-panel fm2-object-data"><header><div><h2>Техническая документация</h2></div></header><div class="fm2-object-tab-panel">
            <?php if ($technicalDocuments['status'] === 'available'): ?><?php foreach ($technicalDocuments['links'] as $link): ?><p><a class="shlz-link" href="<?= Html::encode($link['url']) ?>" rel="noopener noreferrer"><?= Html::encode($link['name']) ?></a></p><?php endforeach ?>
