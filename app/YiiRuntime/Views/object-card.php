...
<div class="fm2-object-dashboard">
    <main>
        ...
        <?php endif ?>
        <?php if ($opened): ?><section class="fm2-panel fm2-next-action"><h2>Монтажные работы</h2><p>Фиксируйте выполненные работы, исполнителей и фотографии в чек-листе.</p><a class="shlz-button shlz-button--primary" href="/pilot/objects/<?= (int)$id ?>/checklist">Перейти к чек-листу</a></section><section id="completion" class="fm2-panel fm2-next-action"><h2>Документарное закрытие</h2><p>Акт ПТО и декларация оформляются в карточке объекта.</p></section><?php endif ?>
