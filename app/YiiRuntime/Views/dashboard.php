...
<ul data-installer-utilization-members><?php foreach($util['members'] as$member):?><li data-installer-tab-id="<?=(int)$member['installerTabId']?>"><strong><?=Html::encode((string)$member['fio'])?></strong> · <?=(int)$member['installerTabId']?></li><?php endforeach?></ul>
