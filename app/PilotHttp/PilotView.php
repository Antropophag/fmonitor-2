...
final class PilotView
{
    ...
    private static function logo():string{return '<svg class="fm2-logo-mark" viewBox="0 0 32 32" aria-hidden="true"><path class="fm2-logo-frame" d="M6.5 25.5V8.7L16 3l9.5 5.7v16.8"/><path class="fm2-logo-signal" d="M10 19.3l5 5 8-9M16 8v10M12.8 11.2 16 8l3.2 3.2"/></svg>';}
    ...
    public static function document(HttpUser $user,string $title,string $current,string $breadcrumb,string $content):string
    {
        ...
        $nav='<a class="fm2-nav-item" href="/pilot/objects"'.$objects.'>'.self::icon('objects').'<span class="fm2-nav-text">Объекты</span></a>'
            .'<span class="fm2-nav-item fm2-nav-item--muted" aria-disabled="true">'.self::icon('orders').'<span class="fm2-nav-text">Распоряжения</span></span>'
            .'<span class="fm2-nav-item fm2-nav-item--muted" aria-disabled="true">'.self::icon('inspections').'<span class="fm2-nav-text">Инспекции</span></span>';
        return '<!doctype html><html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>'.self::e($title).' · FMonitor</title><link rel="stylesheet" href="/pilot/assets/shlz.css"><link rel="stylesheet" href="/pilot/assets/pilot.css"></head><body class="shlz-scope"><a class="fm2-skip shlz-link" href="#main-content">Перейти к содержанию</a><div class="fm2-shell"><aside class="fm2-sidebar"><a class="fm2-logo" href="/pilot/objects" aria-label="FMonitor — объекты монтажа">'.self::logo().'</a><nav class="fm2-primary-nav" aria-label="Основная навигация">'.$nav.'</nav><div class="fm2-sidebar-foot"><span class="fm2-brand-caption" aria-hidden="true">FMonitor</span></div></aside><div class="fm2-workspace"><header class="fm2-topbar"><div><span class="fm2-product">FMonitor</span><strong>'.self::e($title).'</strong></div><div class="fm2-user"><span class="fm2-avatar">'.self::initials($user->displayName).'</span><span><strong>'.self::e($user->displayName).'</strong><small>Сотрудник ФКР</small></span></div></header><main class="fm2-main" id="main-content" tabindex="-1">'.$breadcrumb.$content.'</main></div></div></body></html>';
    }
