...
final class PilotView
{
    ...
    public static function dl(array $pairs,string $class='fm2-details'):string{$html='<dl class="'.$class.'">';foreach($pairs as[$term,$value])$html.='<div><dt>'.$term.'</dt><dd class="fm2-db-text">'.$value.'</dd></div>';return $html.'</dl>';}
}
