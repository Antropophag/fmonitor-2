...
final class PilotView
{
    ...
    {
        $objects=$current==='Объекты монтажа'?' aria-current="page"':'';$installers=$current==='Монтажники'?' aria-current="page"':'';$users=$current==='Пользователи'?' aria-current="page"':'';$roles=$current==='Роли'?' aria-current="page"':'';
