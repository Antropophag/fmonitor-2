...
final class PilotView
{
    ...
    private static function logo():string{return '<svg class="fm2-logo-mark" viewBox="0 0 32 32" aria-hidden="true"><path class="fm2-logo-rail" d="M5 4v24M10 4v24"/><path class="fm2-logo-letter" d="M14 5h13v5h-7v4h6v5h-6v9h-6z"/><path class="fm2-logo-signal" d="M5 16h5m9 0h2l1.5-2 2 4 1.5-2h2"/></svg><span class="fm2-logo-name">FMonitor</span>';}
    ...
    public static function document(HttpUser $user,string $title,string $current,string $breadcrumb,string $content):string
    {
        ...
        $nav='<span class="fm2-nav-group">Работа</span>'.$item('work','Моя работа').'<a class="fm2-nav-item" href="/pilot/objects"'.$objects.'>'.self::icon('objects').'<span class="fm2-nav-text">Объекты монтажа</span></a>'.$item('orders','Распоряжения').$item('inspections','Инспекции')
            .'<span class="fm2-nav-group">Справочники</span>'.$item('installers','Монтажники')
            .'<span class="fm2-nav-group">Управление</span>'.$item('otiz','Расчёты ОТиЗ').$item('control','Контроль').$item('admin','Администрирование');
        $toggle='<input class="fm2-nav-toggle" type="checkbox" id="fm2-nav-toggle"><label class="fm2-nav-toggle-button" for="fm2-nav-toggle" aria-label="Развернуть или свернуть меню"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m9 5 7 7-7 7"/></svg></label>';
        return '<!doctype html><html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>'.self::e($title).' · FMonitor</title><link rel="stylesheet" href="/pilot/assets/shlz.css"><link rel="stylesheet" href="/pilot/assets/pilot.css"></head><body class="shlz-scope"><a class="fm2-skip shlz-link" href="#main-content">Перейти к содержанию</a><div class="fm2-shell"><aside class="fm2-sidebar">'.$toggle.'<a class="fm2-logo" href="/pilot/objects" aria-label="FMonitor — объекты монтажа">'.self::logo().'</a><nav class="fm2-primary-nav" aria-label="Основная навигация">'.$nav.'</nav></aside><div class="fm2-workspace"><header class="fm2-topbar"><div><span class="fm2-product">FMonitor</span><strong>'.self::e($title).'</strong></div><div class="fm2-user"><span class="fm2-avatar">'.self::initials($user->displayName).'</span><span><strong>'.self::e($user->displayName).'</strong><small>Сотрудник ФКР</small></span></div></header><main class="fm2-main" id="main-content" tabindex="-1">'.$breadcrumb.$content.'</main></div></div></body></html>';
    }
