...
final class PilotSessionRequestOwner
{
    ...
    public static function bind(\FMonitor\IdentityAccess\PilotSessionStorage $owner):\FMonitor\IdentityAccess\PilotSessionStorage{if(self::$owner!==null&&self::$owner!==$owner)throw new \LogicException('request session owner already bound');return self::$owner??=$owner;}
