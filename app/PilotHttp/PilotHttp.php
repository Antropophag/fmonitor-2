...
require_once __DIR__.'/AccessPolicy.php';require_once __DIR__.'/PilotRouteCsp.php';
...
final class MariaDbPrepareFormReader implements PrepareFormReader
{
    ...
    public function read(int $id,string $processDate):array|null
    {
        try{
            ...
            return ['id'=>$id,'registrationNumber'=>$registration,'address'=>$address,'entrance'=>$entrance,'plannedStartDate'=>$start,'plannedFinishDate'=>$finish,'installers'=>$installers,'engineer'=>$engineer,'changing'=>$changing,'currentVersion'=>$changing?(int)$currentOrders[0]['version_no']:null,'selected'=>['installers'=>$selected]];
