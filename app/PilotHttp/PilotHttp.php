...
class PilotHttpCoordinator
{
    ...
    public function handle(PilotHttpRequest $r):PilotHttpResponse
    {
        ...
        if(!\in_array($r->path,['/pilot','/pilot/','/pilot/assets/pilot.css','/pilot/assets/picker.js','/pilot/assets/users.js','/pilot/objects'],true)&&!$assetCandidate&&$cardId===null&&$prepareId===null)return $this->response(404,"Not found.\n");
