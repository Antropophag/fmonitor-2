...
class PilotHttpCoordinator
{
    ...
    public function handle(PilotHttpRequest $r):PilotHttpResponse
    {
        ...
        if(!\in_array($r->path,['/pilot','/pilot/','/pilot/assets/pilot.css','/pilot/assets/pilot-20260829-22.css','/pilot/assets/picker.js','/pilot/assets/users.js','/pilot/assets/checklist.js','/pilot/assets/checklist-sw.js','/pilot/assets/control-queue.js','/pilot/objects'],true)&&!$assetCandidate&&$cardId===null&&$prepareId===null&&$checklistId===null)return $this->response(404,"Not found.\n");
        ...
        if(\in_array($r->path,['/pilot/assets/pilot.css','/pilot/assets/pilot-20260829-22.css'],true)){$assetConfigured=$this->dependencies instanceof PilotUiConfiguration&&$this->dependencies->pilotUiConfigured();if(!$assetConfigured)return $this->response(404,"Not found.\n",[],$r->method);try{$body=$this->dependencies->pilotCss()->readBytes();return $this->response(200,$body,['Content-Type'=>'text/css; charset=UTF-8'],$r->method);}catch(CssAssetUnavailable|PilotHttpInfrastructureUnavailable){return $this->response(503,"Service unavailable.\n",['Retry-After'=>'60'],$r->method);}}
