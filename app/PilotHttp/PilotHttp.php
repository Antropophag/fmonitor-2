...
require_once __DIR__.'/AccessPolicy.php';require_once __DIR__.'/PilotRouteCsp.php';require_once __DIR__.'/MariaDbPrepareEngineerDirectory.php';
...
final class MariaDbPrepareFormReader implements PrepareFormReader
{
    ...
    public function read(int $id,string $processDate):array|null
    {
        try{
            ...
            return ['id'=>$id,'registrationNumber'=>$registration,'address'=>$address,'entrance'=>$entrance,'plannedStartDate'=>$start,'plannedFinishDate'=>$finish,'installers'=>$installers,'engineers'=>$engineers,'engineer'=>$engineer,'workforceSource'=>$workforce[0]['workforce_source']??null,'workforceUpdatedAt'=>$workforce[0]['workforce_source_updated_at']??null,'changing'=>$changing,'currentVersion'=>$changing?(int)$currentOrders[0]['version_no']:null,'selected'=>['installers'=>$selected]];
