...
final class ProductionPilotHttpEntrypointFactory
{
    ...
    ):PilotHttpEntrypoint
    {
        ...
        return new PilotHttpEntrypoint(new PilotHttpRequestFactory(),new ExecutionHttpCoordinator(new FreshOrderHttpCoordinator($application,$environment),$environment),$dependencies,new RandomCorrelationIdSource(),new ErrorLogUnexpectedFailureReporter());
    }
    ...
    public static function createWithSessionStorageDependencies(
        ...
        return new PilotHttpEntrypoint(new PilotHttpRequestFactory(),new ExecutionHttpCoordinator(new FreshOrderHttpCoordinator($application,$environment),$environment),$dependencies,new RandomCorrelationIdSource(),new ErrorLogUnexpectedFailureReporter(),self::localAuth($owner));
    }
