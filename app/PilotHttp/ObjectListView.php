...
final class ProductionObjectListRenderer implements ObjectListRenderer,CompatibilityObjectListRenderer
{
    ...
    public function renderCompatibility(HttpUser $user,array $objects):string
    {
        ...
        return $this->compatibilityDocument($user,$body);
    }
    private function compatibilityDocument(HttpUser $user,string $body):string{return '<!doctype html><html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Объекты монтажа — FMonitor 2.0</title><link rel="stylesheet" href="/pilot/assets/shlz.css"></head><body class="shlz-scope"><a class="shlz-link" href="#main-content">Перейти к содержанию</a><header><strong>FMonitor 2.0</strong><span>'.PilotView::e($user->displayName).'</span></header><nav aria-label="Основная навигация"><a class="shlz-link" href="/pilot/">Моя работа</a><a class="shlz-link" href="/pilot/objects" aria-current="page">Объекты монтажа</a></nav><main id="main-content" tabindex="-1">'.$body.'</main></body></html>';}
}
