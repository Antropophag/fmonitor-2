...
final class PilotRouteAdmission
{
    ...
    public static function isKnown(string $path): bool
    {
        return \in_array($path, [
            ...
            || \preg_match('#^/pilot/objects/[1-9][0-9]*(?:/assignment-order/(?:prepare|selection)|/assignment-orders/[1-9][0-9]*/(?:registration|template|originals(?:/submit)?|artifacts/(?:order|appendix|signed_original))|/control-engineer|/open|/checklist(?:/operations|/photos)?)?$#D', $path) === 1
