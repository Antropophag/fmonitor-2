    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'POST pilot/objects/<id:[1-9]\\d*>/checklist/operations' => 'checklist/operation',
                'POST pilot/construction-control/objects/<id:[1-9]\\d*>/checklist/operations' => 'checklist/operation',
                'POST pilot/objects/<id:[1-9]\\d*>/checklist/photos' => 'checklist/photo',
                'POST pilot/construction-control/objects/<id:[1-9]\\d*>/checklist/photos' => 'checklist/photo',
                'pilot/objects/<id:[1-9]\\d*>/checklist' => 'object-card/method',
                'pilot/construction-control/objects/<id:[1-9]\\d*>/checklist' => 'object-card/method',
                'pilot/construction-control/objects/<id:[1-9]\\d*>/sync-context' => 'object-card/method',
                'pilot/objects/<id:[1-9]\\d*>/checklist/operations' => 'checklist/operation',
                'pilot/construction-control/objects/<id:[1-9]\\d*>/checklist/operations' => 'checklist/operation',
                ...
                'GET pilot/otiz/reconciliation' => 'otiz-evidence/reconciliation',
                'GET pilot/otiz/reconciliation/quarantine' => 'otiz-evidence/quarantine',
                'GET pilot/otiz/active-baselines' => 'otiz-evidence/active-baselines',
                'GET pilot/otiz/historical-replay' => 'otiz-evidence/historical-replay',
                'POST pilot/otiz/calculate' => 'otiz-publication/calculate',
                'POST pilot/otiz/snapshots/<id:\\d+>/accept' => 'otiz-publication/accept',
                'POST pilot/otiz/reconciliation/decisions' => 'otiz-evidence/reconciliation-decision',
                'POST pilot/otiz/reconciliation/quarantine/decisions' => 'otiz-evidence/quarantine-decision',
