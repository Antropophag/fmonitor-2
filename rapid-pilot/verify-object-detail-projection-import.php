...
$ui=(string)file_get_contents(__DIR__.'/ObjectDetails.php');if(!str_contains($ui,'projectionUnavailable')||str_contains($ui,'fallbackDetails'))throw new RuntimeException('Object detail projection must fail closed');
