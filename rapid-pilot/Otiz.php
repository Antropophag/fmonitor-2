...
final class RapidPilotOtiz
{
    ...
    private function objects(): never
    {
        ...
        $body .= '</tbody></table><div class="fm2-otiz-register-empty" data-otiz-empty hidden><h2>Объекты не найдены</h2><p>Измените запрос или состояние — данные расчётов не меняются.</p></div></div></section>';
