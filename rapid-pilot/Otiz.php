...
final class RapidPilotOtiz
{
    ...
    private function snapshot(int $id): never
    {
        ...
        foreach ($objects as $o) {
            ...
            $status = $o['calculation_state'] === 'blocked' ? ['shlz-status--orange','Требует данных'] : ($o['calculation_state'] === 'no_new_amount' ? ['','Нет новой суммы'] : ($o['calculation_state'] === 'completed' ? ['shlz-status--green','Выплата завершена'] : ['shlz-status--blue','Готов к выплате']));
    ...
    private function history(): never
    {
        ...
        $body = '<header class="fm2-page-header"><div><h1>Архив расчётов</h1><p>Здесь хранятся подготовленные и подтверждённые расчёты за выбранные даты.</p></div></header><nav class="fm2-otiz-subnav" aria-label="Раздел ОТиЗ"><a class="shlz-link" href="/pilot/otiz">Подготовка выплат</a><a class="shlz-link" href="/pilot/otiz/objects">Объекты</a><a class="shlz-link" aria-current="page" href="/pilot/otiz/history">Архив расчётов</a></nav><section class="fm2-list-surface"><div class="fm2-table-wrap"><table class="shlz-table fm2-queue-table fm2-otiz-history"><thead><tr><th>Дата расчёта</th><th>Состояние</th><th>Подтверждён</th><th>К выплате</th><th>Выплачено ранее</th></tr></thead><tbody>';
    ...
    private function objects(): never
    {
        ...
        $body .= '<nav class="fm2-otiz-subnav" aria-label="Раздел ОТиЗ"><a class="shlz-link" href="/pilot/otiz">Подготовка выплат</a><a class="shlz-link" aria-current="page" href="/pilot/otiz/objects">Объекты</a><a class="shlz-link" href="/pilot/otiz/history">Архив расчётов</a></nav>';
