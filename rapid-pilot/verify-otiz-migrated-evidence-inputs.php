...
$sentinel=$confirmed;$sentinel['evidenceGrade']='Q';$sentinel['confidence']='low';$sentinel['conflictCodes']=['LEGACY_UNASSIGNED_SENTINEL'];$sentinel['attributionObservations']=[];$sentinel['workforceFacts']=[];$sentinel['progressMapping']=['candidateProgressBp'=>null,'eligibleForCalculation'=>false,'conflictCodes'=>['LEGACY_UNASSIGNED_SENTINEL']];$sentinelInput=OtizMigratedEvidenceInputs::forObject(7101,[7101=>$sentinel]);evidenceCheck($sentinelInput===['mode'=>'synthetic_fallback','reconciliationClaim'=>false,'admittedEvidence'=>null,'exclusionReason'=>'LEGACY_UNASSIGNED_SENTINEL'],'sentinel is explicitly blocked before progress, performer, KTU or calculation admission');
