...
query and an explicitly decimal page when supplied. It returns at most 20 rows plus `hasMore`; the SQL
...
c6e6afbe8db56d10058e0c8edc48fcf0b0b798b0f487c6c3276920e620347067  app/PilotHttp/FreshOrderHttpHandler.php
3a62cd1ca7e022a9735c8cdd46a1b79ceb144f9261a4881059cf2e0e2fc94f74  app/PilotHttp/FreshOrderSelectionView.php
...
4bf6e62ac0245fb16a05ef1f65be924dd75c696a6a5d1dde60c5fbcf7de9b25b  rapid-pilot/pilot.css
...
Root-owned headless browser verification on the stand additionally observed the
ordinary flow: page 1 returned 20 rows, page 2 returned 7, a cleared query emptied
the results, two choices survived paging/reopen and were saved, and the flow reached
successful original upload (`201`). A 390×844 mobile screenshot showed the modal
within the viewport with its close control and three-line result rows visible. This
review records that supplied browser result; the reviewer did not operate the stand.
