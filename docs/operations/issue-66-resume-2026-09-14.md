...
## 2026-09-14 21:33 UTC — complete second CI triage and browser date correction

Exact-source CI34897403000 on408bada completed: fast, unit, both integration shards and governance passed. The complete regression inventory contains one failure, `tests/Yii2/excel_publication_browser_001_test.php`; verify failed consequently. Quality Graph reported failure; its Actions job-log endpoint returned404. Complete run JSON, failed-job logs and inventory are outside the checkout under `~/.local/share/fmonitor-2/issue66-ci-34897403000-*`. Every available failure was inspected before correction publication.

Root reproduced the exact recurrence mismatch locally after Moscow midnight: a real payment on September15 was correctly excluded from the hardcoded September14 report. This was a root-authored fixture defect, not a production calculation defect. Root changed only the browser fixture dates: report tomorrow, certificate today, deadline yesterday, retaining two late days and exact1,274,000 then25,480 cent expectations. Real application acceptance/payment timestamps are preserved; previous test timestamp backdating was removed. Source, PDF, UI and XLSX assertions remain.

Root-authored correction received independent sol/low review_calc Gate3 and Gate5 APPROVED. RED record1789421047653001000-4e05aafd9fc046b9a868239b2070b9c7; corrected GREEN1789421431877653000-eaee1fb80eac420ca37e3a7597df923e (executable f606bc3c0a07919d66aae560aa0220357cc2f980a798ae3783b2f2656163c7f7). Gate5 package20260914T213231Z-5cb47b19b0. This checkpoint follows the focused test and changes documentation only. Final exact-commit CI remains pending; PR143 is draft until its result is known. No deployment, merge or stand mutation.
