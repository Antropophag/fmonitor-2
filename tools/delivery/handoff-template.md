...
- Preserved WIP / stand: <pointer if relevant>.

Use links to sources of truth. Return a complete findings list, changed files,
commands/results and verdict; omit conversation history and raw private journals.
