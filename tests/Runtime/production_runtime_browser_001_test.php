...
function prbSeed(SelectedOriginalFixture $fixture,string $password):void
{
    ...
    assertSameValue([0,true,28,true],[$migration['exitCode'],$migration['result']['ok']??null,$migration['result']['schemaVersion']??null,InspectionPhotoContentIndexSchemaMigration::isCompleteCompatible($db,$p)],'fixture canonical v28');
