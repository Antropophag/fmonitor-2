...
$source=(string)file_get_contents(dirname(__DIR__,2).'/app/RuntimeRestore/RuntimeRecovery.php');$inventory=FMonitor2\RuntimeRestore\RuntimeRecoverySchemaV32::tables('');
assertSameValue(true,str_contains($source,'RuntimeRecoverySchemaV32::tables'),'A15 current recovery consumes the canonical inventory owner');
