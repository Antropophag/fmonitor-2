...
// Specification: ORDER-PREPARE-002-B, example A.
$initialProcess = [
...
$environment->setNow('2026-08-27T11:45:00+03:00');
...
assertSameValue(
    ...
    $result,
    'ORDER-PREPARE-002-B must reject preparation when the installation object address is blank.',
);
...
assertSameValue(
    ...
    'ORDER-PREPARE-002-B must append one rejection event without partial process changes.',
);

fwrite(STDOUT, "PASS ORDER-PREPARE-002-B blank address\n");
