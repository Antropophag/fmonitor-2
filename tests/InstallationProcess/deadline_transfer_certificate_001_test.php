...
try{
    ...
    $tables=FMonitor2\RuntimeRestore\RuntimeRecoverySchemaV27::tables($p);assertSameValue(78,count($tables),'v27 exact table inventory');assertSameValue(42,count(FMonitor2\RuntimeRestore\RuntimeRecoverySchemaV27::autoIncrement($p)),'v27 counters');
