...
try{
    ...
    $tables=FMonitor2\RuntimeRestore\RuntimeRecoverySchemaV26::tables($p);assertSameValue(77,count($tables),'v26 exact table inventory');assertSameValue(42,count(FMonitor2\RuntimeRestore\RuntimeRecoverySchemaV26::autoIncrement($p)),'v26 counters');
