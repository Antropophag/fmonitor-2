...
try{
    ...
    $tables=FMonitor2\RuntimeRestore\RuntimeRecoverySchemaV28::tables($p);assertSameValue(79,count($tables),'v28 exact table inventory');assertSameValue(43,count(FMonitor2\RuntimeRestore\RuntimeRecoverySchemaV28::autoIncrement($p)),'v28 counters');
