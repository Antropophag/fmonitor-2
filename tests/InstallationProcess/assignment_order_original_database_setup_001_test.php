...
$normalizeCheck=static function(string$value)use($validateBooleanLexical,$serializeBoolean,$parseBoolean):string{$validateBooleanLexical($value);return$serializeBoolean($parseBoolean(strtolower(str_replace('`','',$value))));};
