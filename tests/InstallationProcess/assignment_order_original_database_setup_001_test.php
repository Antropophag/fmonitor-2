...
try {
    ...
    assertSameValue(true,function_exists('proc_open')&&function_exists('proc_terminate')&&function_exists('proc_close'),'Serializable contention verifier requires bounded process control.');
