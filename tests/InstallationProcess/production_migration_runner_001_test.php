...
function pmrCatalog(mysqli $connection, string $prefix): void
{
    ...
    $expectedTables = array_map(static fn (string $table): string => $prefix . $table, [...array_keys($contract),...$newTables,'fm2_installer_utilization_observations','fm2_installer_utilization_observation_members']);
