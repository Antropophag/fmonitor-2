...
try{
 ...
 $upgrade=Migration::run($db,$p,Catalogue::migrations());assertSameValue([0,29],[$upgrade['exitCode'],$upgrade['result']['schemaVersion']??null],'v25 forward through28');
 ...
 $fresh=$f->database();assertSameValue([0,29],(static function($r){return[$r['exitCode'],$r['result']['schemaVersion']??null];})(Migration::run($fresh,$p,Catalogue::migrations())),'clean canonical29');
 ...
 $priorCatalogue=Catalogue::migrations();unset($priorCatalogue[26],$priorCatalogue[27],$priorCatalogue[28],$priorCatalogue[29]);
 ...
 assertSameValue([0,29],[$prefixed['exitCode'],$prefixed['result']['schemaVersion']??null],'RED_ASSERTION certificate supports canonical 25-byte prefix through v29');
