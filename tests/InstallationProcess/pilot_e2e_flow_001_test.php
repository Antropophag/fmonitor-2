...
function pefProtectedSeed(FMonitor2\Tests\Support\SelectionHttpFixture $fixture,string $password):void
{
    ...
    assertSameValue([0,true,22,true],[$migration['exitCode'],$migration['result']['ok']??null,$migration['result']['schemaVersion']??null,FMonitor2\InstallationProcess\InspectionPhotoContentIndexSchemaMigration::isCompleteCompatible($db,$p)],'protected fixture reaches exact canonical v22 frontier without conflict');
