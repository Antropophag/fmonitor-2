...
try{
    ...
    $repeat=CanonicalMigrationApplication::run($db,$prefix,$catalogue);assertSameValue([0,['ok'=>true,'schemaVersion'=>28,'appliedVersions'=>[]]],[$repeat['exitCode'],$repeat['result']],'compatible populated repeat is no-op');
