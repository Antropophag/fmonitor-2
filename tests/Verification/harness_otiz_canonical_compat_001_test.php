...
assertSameValue(
    ['status'=>0, 'stdout'=>"{\"ok\":true,\"schemaVersion\":22,\"appliedVersions\":[]}\n", 'stderr'=>''],
    $migration,
    "SETUP_FAILURE: prepared canonical v22 must return the exact no-op process result; evidence=$migrationEvidence",
);
