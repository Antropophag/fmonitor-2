...
assertSameValue(
    ['status'=>0, 'stdout'=>"{\"ok\":true,\"schemaVersion\":24,\"appliedVersions\":[]}\n", 'stderr'=>''],
    $migration,
    "SETUP_FAILURE: prepared canonical v24 must return the exact no-op process result; evidence=$migrationEvidence",
);
