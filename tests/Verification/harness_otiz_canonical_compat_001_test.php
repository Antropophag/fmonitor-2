...
assertSameValue(
    ['status'=>0, 'stdout'=>"{\"ok\":true,\"schemaVersion\":23,\"appliedVersions\":[]}\n", 'stderr'=>''],
    $migration,
    "SETUP_FAILURE: prepared canonical v23 must return the exact no-op process result; evidence=$migrationEvidence",
);
