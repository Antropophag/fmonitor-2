...
assertSameValue(
    ['status'=>0, 'stdout'=>"{\"ok\":true,\"schemaVersion\":12,\"appliedVersions\":[]}\n", 'stderr'=>''],
    $migration,
    "SETUP_FAILURE: prepared canonical v12 must return the exact no-op process result; evidence=$migrationEvidence",
);
