...
assertSameValue(
    ['status'=>0, 'stdout'=>"{\"ok\":true,\"schemaVersion\":21,\"appliedVersions\":[]}\n", 'stderr'=>''],
    $migration,
    "SETUP_FAILURE: prepared canonical v21 must return the exact no-op process result; evidence=$migrationEvidence",
);
