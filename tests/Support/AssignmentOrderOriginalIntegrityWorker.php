...
final class OriginalIntegrityWorker
{
    ...
    private int $started;
    public function __construct(OriginalIntegrityDatabase $fixture,array $command,array $changes=[])
    {
        ...
        try{
            ...
            if(fwrite($this->pairs[0][0],$input)!==strlen($input))throw new \RuntimeException('SETUP_FAILURE: worker command write');stream_socket_shutdown($this->pairs[0][0],STREAM_SHUT_WR);
