...
function jobsAssertSchema(mysqli $db, string $prefix): void
{
    $manifest = json_decode(file_get_contents(__DIR__.'/jobs_schema_manifest.json'), true, 512, JSON_THROW_ON_ERROR);
