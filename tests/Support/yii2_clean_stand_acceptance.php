...
function deriveFacts(array $driver, array $manifest, array $auth): array
{
    ...
    if (($db['schemaBefore']??null)!==[] || ($db['schemaVersion']??null)!==28 || count($db['migrationLedger']??[])!==28) emit('PROVISIONING_INVALID');
