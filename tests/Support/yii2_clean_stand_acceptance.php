...
function deriveFacts(array $driver, array $manifest, array $auth): array
{
    ...
    if (($db['schemaBefore']??null)!==[] || ($db['schemaVersion']??null)!==30 || count($db['migrationLedger']??[])!==30) emit('PROVISIONING_INVALID');
