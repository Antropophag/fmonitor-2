...
function deriveFacts(array $driver, array $manifest, array $auth): array
{
    ...
    if (($db['schemaBefore']??null)!==[] || ($db['schemaVersion']??null)!==29 || count($db['migrationLedger']??[])!==29) emit('PROVISIONING_INVALID');
