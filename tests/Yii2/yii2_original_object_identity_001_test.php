...
try {
    ...
    $effectiveProbe=$f->artifacts.'/effective-read-probe.jsonl';$includeTrace=$f->artifacts.'/includes.jsonl';$traceProperty=(new ReflectionClass($f))->getProperty('traceNonce');$traceNonce=$traceProperty->getValue($f);
