...
try {
 ...
 $missingSelection=['_csrf'=>$f->token($cookies),'requestId'=>'11111111-1111-4111-8111-000000000077','mode'=>'new_order','expectedSelectionRevision'=>'0','expectedControlEngineerAssignmentRevision'=>'1','installerTabIds'=>[7001]];
