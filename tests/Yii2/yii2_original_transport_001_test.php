...
try {
 ...
 $correction['requestId']='22222222-2222-4222-8222-000000000003';assertSameValue(409,$f->upload($cookies,$correction,$pdf2)['status'],'stale target conflict');assertSameValue($now,$f->rows('fm2_assignment_order_original_revisions'),'conflict preserves revisions');
