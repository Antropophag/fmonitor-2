...
try {
    ...
    $cases=[
        ...
        'noncanonical length'=>[$fields,['Content-Length'=>'0327'],18,400,'INVALID_REQUEST'],
        'transfer encoding'=>[$fields,['Transfer-Encoding'=>'identity'],18,400,'INVALID_REQUEST'],
        ...
        'shape before CSRF'=>[array_replace($unknown,['csrfToken'=>'bad']),[],18,400,'INVALID_REQUEST'],
        'alternate JSON encoding'=>[$fields,['X-FMonitor-Original'=>base64_encode(str_replace('signed.pdf','signed\\u002epdf',$json))],18,400,'INVALID_REQUEST'],
