...
try{
    ...
    $canonical=CanonicalMigrationApplication::run($db,$clean,$catalogue);assertSameValue([0,true,26,range(1,26)],[$canonical['exitCode'],$canonical['result']['ok']??null,$canonical['result']['schemaVersion']??null,$canonical['result']['appliedVersions']??null],'clean canonical migration reaches the complete v24 frontier');
    $repeat=CanonicalMigrationApplication::run($db,$clean,$catalogue);assertSameValue([0,true,26,[]],[$repeat['exitCode'],$repeat['result']['ok']??null,$repeat['result']['schemaVersion']??null,$repeat['result']['appliedVersions']??null],'complete canonical v26 repeat is a no-op');
