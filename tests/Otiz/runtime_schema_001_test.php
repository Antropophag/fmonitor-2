...
try{
    ...
    $canonical=CanonicalMigrationApplication::run($db,$clean,$catalogue);assertSameValue([0,true,23,range(1,23)],[$canonical['exitCode'],$canonical['result']['ok']??null,$canonical['result']['schemaVersion']??null,$canonical['result']['appliedVersions']??null],'clean canonical migration reaches the complete v23 frontier');
    $repeat=CanonicalMigrationApplication::run($db,$clean,$catalogue);assertSameValue([0,true,23,[]],[$repeat['exitCode'],$repeat['result']['ok']??null,$repeat['result']['schemaVersion']??null,$repeat['result']['appliedVersions']??null],'complete canonical v23 repeat is a no-op');
