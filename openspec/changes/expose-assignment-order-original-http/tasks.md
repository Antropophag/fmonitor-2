...
- [ ] 1.2 Проверить inherited read grants; verification: exact source устанавливает круг читателей либо NEEDS_GRILL фиксирует недостающий owner decision до read/download RED.
...
- [ ] 2.2 Добавить read/download authorization, history, hash/size, отсутствующий evidence и storage-failure tests; verification: RED наблюдается через публичный маршрут и не использует verification reader как product API.
