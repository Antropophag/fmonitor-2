...
Не входит: opening, применение состава, OCR, интеграция 1С ДО, изменение blocked `PILOT-E2E-FLOW-001`, PR #10 или Quality Graph. Implementation заблокирован до полного command Gate 5 и independent Gate 1 этого slice. Owner decision от 2026-09-05 разрешает указанный read scope, включая ОТиЗ по всем распоряжениям; права чтения не выводятся автоматически из upload/correct.
