...
- [ФИО и агрегаты монтажников становятся доступны всем активным ролям] → это явное решение владельца; гостевой и inactive доступ остаются закрытыми, а standalone permissions не расширяются.
