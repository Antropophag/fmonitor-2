...
- Показывать загрузку монтажников за фиксированные шесть календарных недель — две прошлые, текущую и три будущие — без controls мотания; полный список людей остаётся только в drill-down.
- Разместить диаграмму загрузки справа от «Объекты по этапам процесса» в равной двухколоночной композиции; внутренняя вёрстка точно повторяет «Плановую нагрузку на 6 недель».
