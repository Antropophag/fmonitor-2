...
- [x] 5.4 Получить независимый Gate5 review spec/approved tests/production diff/evidence, затем один полный CI `make test`; не заявлять #34 delivered/production ready без обоих GREEN
