...
- [x] 2.2 Поручить tests fresh independent reviewer; verification: review APPROVED и фиксирует hashes, env isolation, list-representation independence и negative sensitivity.
