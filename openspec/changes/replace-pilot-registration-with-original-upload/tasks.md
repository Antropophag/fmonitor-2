...
- [ ] 1.10 Получить fresh independent Gate 1 review owner-approved `checklistSha256` evidence amendment; verification: exact `aoou-process-v1` shape отдельно фиксирует canonical checklist availability и task 2.2 снова разрешена
