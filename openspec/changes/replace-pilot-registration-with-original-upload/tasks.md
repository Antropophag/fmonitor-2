...
- [ ] 1.21 Получить fresh independent Gate 1 review combined release-fault amendment; verification: exact rollback/unknown+release scripts и plain committed/CAS release fault покрывают every safe-log phase без arbitrary list/production selector
