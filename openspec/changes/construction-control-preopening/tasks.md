...
- [x] 3.3 Создать commit/PR и выполнить один exact-source Quality Graph CI; merge/закрытие #40 допустимы только при подтверждённом GREEN, deployment остаётся UNKNOWN
