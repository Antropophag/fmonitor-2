...
- [x] 2.2 Реализовать общую configuration и Yii web/console health lifecycle; focused test GREEN.
- [x] 2.3 Собрать isolated PHP8.4 FPM/nginx contour; HTTP smoke и безопасная readiness failure GREEN.
- [x] 2.4 Подключить тест к verification inventory и dependency bootstrap; focused architecture/regression GREEN.
