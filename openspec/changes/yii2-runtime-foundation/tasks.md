...
- [ ] 1.1 Проверить inventory и ADR с независимой проверкой карты входов.
- [ ] 1.2 Зафиксировать YII2-RUNTIME-001 и intended RED реальных HTTP/CLI проверок.
- [ ] 1.3 Получить независимый Gate3 APPROVED на спецификацию и тесты.

## 2. Runtime

- [ ] 2.1 Подключить Yii2 через общий Composer lock; проверить clean install и pinned TCPDF.
- [ ] 2.2 Реализовать общую configuration и Yii web/console health lifecycle; focused test GREEN.
- [ ] 2.3 Собрать isolated PHP8.4 FPM/nginx contour; HTTP smoke и безопасная readiness failure GREEN.
