...
- [ ] 2.1 Exact committed candidate проходит один полный CI по действующей матрице; PR/merge записаны отдельно от deployment, record содержит agent/review/check counts и причины.

Done: выполнены все пункты; stand cutover и остальные срезы #76 не объявляются завершёнными.
