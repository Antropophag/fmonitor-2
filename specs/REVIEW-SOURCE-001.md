...
| isolation | ignored файл и чистый tracked файл | ignored файл не попадает в patch/restore; чистый tracked файл берётся из base. SNAPSHOT и DESTINATION не должны существовать; capture внутри исходного checkout отвергается до записи. |
