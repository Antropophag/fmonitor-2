...
- для сторно — идентификатор исходной closure и работающую связь на фактическую страницу/якорь исходной строки, только если исходная строка относится к тому же объекту и присутствует в доступной истории.
