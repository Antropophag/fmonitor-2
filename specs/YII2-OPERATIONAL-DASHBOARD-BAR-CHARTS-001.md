...
Значение каждого bucket равно числу строк с соответствующей канонической отображаемой меткой в полном результате обычного реестра на том же fixture/cutoff; сумма равна dashboard `total`. Chart drill-down использует новый взаимоисключающий stage bucket. Исторический ordinary `status=installation` сохраняет predecessor-смысл активной рабочей очереди и не является доказательством взаимоисключающей stage-классификации. Правила отображаемого статуса имеют одного production owner, а не параллельную упрощённую формулу.
